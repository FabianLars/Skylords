...
function CardData.custom_card(frame)
    ...
    return CardClass{
        ...
        orb_1_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[1]),
        orb_2_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[2]),
        orb_3_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[3]),
        orb_4_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[4]),
