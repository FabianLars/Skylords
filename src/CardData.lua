...
function CardData.custom_card(frame)
    ...
    return CardClass{
        ...
        orb_1_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[1] or nil),
        orb_2_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[2] or nil),
        orb_3_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[3] or nil),
        orb_4_wktxt = format('[[File:Tokenslot_Orb_%s.png||link=]]', args.orbs[4] or nil),
